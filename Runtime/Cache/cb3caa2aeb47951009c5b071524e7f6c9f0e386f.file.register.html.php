<?php /* Smarty version Smarty-3.1.6, created on 2016-07-21 15:37:43
         compiled from "E:/xampp/htdocs/shop/Home/View\User\register.html" */ ?>
<?php /*%%SmartyHeaderCode:244257903c05431677-73634807%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cb3caa2aeb47951009c5b071524e7f6c9f0e386f' => 
    array (
      0 => 'E:/xampp/htdocs/shop/Home/View\\User\\register.html',
      1 => 1469086657,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '244257903c05431677-73634807',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57903c054c9c1',
  'variables' => 
  array (
    'errorInfo' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_57903c054c9c1')) {function content_57903c054c9c1($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
    ...
    <div class="block box">
        ...
        <div class="usBox">
            <div class="usBox_2 clearfix">
                ...
                <form id="yw0" action="<?php echo @__MODULE__;?>
/User/register" method="post">                <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                    <tbody>
                    <tr>
                        ...
                        <td style="width:87%;">
                            <input class="inputBg" size="25" name="u_username" id="User_username" type="text" value="" />
                            <span style="color:red;"><?php echo $_smarty_tpl->tpl_vars['errorInfo']->value['u_username'];?>
</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input class="inputBg" size="25" name="u_password" id="User_password" type="password" value="" />
                            <span style="color:red;"><?php echo $_smarty_tpl->tpl_vars['errorInfo']->value['u_password'];?>
</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input class="inputBg" size="25" name="u_password2" id="User_password2" type="password" />
                            <span style="color:red;"><?php echo $_smarty_tpl->tpl_vars['errorInfo']->value['u_password2'];?>
</span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="inputBg" size="25" name="u_email" id="User_user_email" type="text" value="" />
                            <span style="color:red;"><?php echo $_smarty_tpl->tpl_vars['errorInfo']->value['u_email'];?>
</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input class="inputBg" size="25" name="u_qq" id="User_user_qq" type="text" value="" />
                            <span style="color:red;"><?php echo $_smarty_tpl->tpl_vars['errorInfo']->value['u_qq'];?>
</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input class="inputBg" size="25" name="u_tel" id="User_user_tel" type="text" value="" />
                            <span style="color:red;"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['errorInfo']->value['u_tel'])===null||$tmp==='' ? '' : $tmp);?>
</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                                            ...
                                            <input id="User_user_sex_0" value="1" checked="checked" type="radio" name="u_sex" />
                                            <label for="User_user_sex_0">男</label>&nbsp;
                                            <input id="User_user_sex_1" value="2" type="radio" name="u_sex" />
                                            <label for="User_user_sex_1">女</label>&nbsp;
                                            <input id="User_user_sex_2" value="3" type="radio" name="u_sex" />
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="u_xueli" id="User_user_xueli">
